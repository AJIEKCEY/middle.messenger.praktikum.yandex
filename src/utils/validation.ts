export const VALIDATION_RULES = {
  ...
  phone: /^\+?\d{1,4}[-.\s]?(\(\d{1,5}\)|\d{1,5})[-.\s]?\d{1,5}[-.\s]?\d{1,5}[-.\s]?\d{1,5}[-.\s]?\d{1,5}$/,
  message: /.+/,
  manageUsers: /^\d+(,\d+)*$/
};

export const VALIDATION_MESSAGES = {
  login: "Длина от 3 до 20 символов, латиница, может содержать цифры, но не состоять из них, без пробелов," +
  ...
  manageUsers: "Введите один или несколько идентификаторов пользователей, разделенных запятой",
};
